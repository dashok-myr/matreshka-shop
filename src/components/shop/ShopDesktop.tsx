  ...
  return (
    <div className="py-10 px-10">
      <div className="grid md:grid-cols-6 gap-4 w-full">
        ...
        <div
          className="col-start-5 col-span-2 border-2 border-gray-800 relative"
        ...
        >
          ...
          />
          <button className="absolute inset-1/3 opacity-70 aspect-video bg-white border-2 border-black shadow hover:bg-gray-300">
            <div className="flex flex-col h-full justify-center">
        ...
        <div
          className="col-start-1 col-span-3 border-2 border-gray-800 relative"
        ...
        <div
          className="col-start-4 col-span-3 border-2 border-gray-800 relative"
